...
pub struct BatchThawAccounts<'info> {
    ...
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_1_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_2: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_2_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_3: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_3_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_4: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_4_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_5: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_5_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_6: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_6_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_7: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_7_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_8: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_8_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_9: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_9_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_10: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_10_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_11: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_11_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_12: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_12_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_13: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_13_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_14: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_14_token_ata: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account[mut]]
    pub user_15: AccountInfo<'info>,
    /// CHECK: This is an ata for coop token for user.
    #[account(mut)]
    pub user_15_token_ata: AccountInfo<'info>,
    // /// CHECK: This is an ata for coop token for user.
    // #[account[mut]]
    // pub user_16: AccountInfo<'info>,
    // /// CHECK: This is an ata for coop token for user.
    // #[account(mut)]
    // pub user_16_token_ata: AccountInfo<'info>,
    /// SPL Token program
...
impl<'info> BatchThawAccounts<'info> {
    pub fn batch_thaw_accounts(&mut self) -> Result<()> {
        ...
        unfreeze_user_token_account(
            self.global_vault.to_account_info(),
            self.coop_token.to_account_info(),
            self.user_11_token_ata.to_account_info(),
            self.token_program.to_account_info(),
            &[seeds_for_unfreeze],
        )?;
        ...
        unfreeze_user_token_account(
            self.global_vault.to_account_info(),
            self.coop_token.to_account_info(),
            self.user_12_token_ata.to_account_info(),
            self.token_program.to_account_info(),
            &[seeds_for_unfreeze],
        )?;
        ...
        unfreeze_user_token_account(
            self.global_vault.to_account_info(),
            self.coop_token.to_account_info(),
            self.user_13_token_ata.to_account_info(),
            self.token_program.to_account_info(),
            &[seeds_for_unfreeze],
        )?;
        unfreeze_user_token_account(
            self.global_vault.to_account_info(),
            self.coop_token.to_account_info(),
            self.user_14_token_ata.to_account_info(),
            self.token_program.to_account_info(),
            &[seeds_for_unfreeze],
        )?;
        ...
        unfreeze_user_token_account(
            self.global_vault.to_account_info(),
            self.coop_token.to_account_info(),
            self.user_15_token_ata.to_account_info(),
            self.token_program.to_account_info(),
            &[seeds_for_unfreeze],
        )?;
        ...
        //     self.global_vault.to_account_info(),
        //     self.coop_token.to_account_info(),
        //     self.user_16_token_ata.to_account_info(),
        //     self.token_program.to_account_info(),
        //     &[seeds_for_unfreeze],
        // )?;
